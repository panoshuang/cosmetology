...
{   
    ...
    switch (_type)
    {
        ...
        {
            CGFloat tilt = [self valueForOption:iCarouselOptionTilt withDefault:0.5f]; //倾斜度
            CGFloat spacing = [self valueForOption:iCarouselOptionSpacing withDefault:1.f]; //空隙
